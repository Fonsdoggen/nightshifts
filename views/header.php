<header>
    ...
    <div class="nav">
        ...
        <a href="<?php echo $base_url; ?>acters/personages.php"><button class="dropbtn <?php if (strpos($_SERVER['REQUEST_URI'], "nightshifts/personages") !== false){echo "active";} ?>">Movies</button></a>
